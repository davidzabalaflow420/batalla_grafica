texto_intro = '''Bienvenido a Battleship: la misión
-.-.-.-.-.-.-.-.-.-.
...
título = 'BattleShip'
texto_creditos = '''BattleShip es un juego desarrollado con 
              Python y Pygame
...
texto_instruccion = '''Instrucciones del juego:

BattleShip es un juego de batalla naval donde debes hundir los barcos 
del enemigo antes de que él hunda los tuyos.

Colocación de barcos:
- Pulsa el botón derecho del ratón para girar los barcos 
  horizontalmente o verticalmente.
- Pulsa el botón izquierdo del ratón para colocar un barco 
  en una casilla del tablero.
- No puedes sacar un barco del tablero ni juntar 
  dos barcos en vertical u horizontal.
- Pulsa ENTER cuando hayas terminado de colocar todos tus barcos.

Disparo:
- Escribe una letra seguida de un número para seleccionar las 
  coordenadas del tablero donde quieres disparar.
- Pulsa ENTER después de escribir las coordenadas.

Objetivo:
- Hundir todos los barcos del enemigo antes de que 
  él hunda los tuyos para ganar la batalla.

¡Buena suerte!
'''
texto_instrucciones = 'Instrucciones'
texto_juego_por_consola = 'Juego por consola'
